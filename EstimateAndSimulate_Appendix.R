...
file<-"shortoutputs/priors_Appendix.rds"
...
if (!file.exists(file)) {
  ...
  dStan$prior_r[2]<-dStan$prior_r[2]*8
  dStan$prior_lambda[2]<-dStan$prior_lambda[2]*8
...
file<-"shortoutputs/simulation_Appendix.rds"
